...
export default function Dashboard() {
  ...
  const clickInformation = () => {
    ...
    navigate('/web-user/information');

  };

  const clickUpdate = () => {

    navigate('/web-user/update');

  };

  const clickUpdatePassword = () => {

    navigate('/web-user/update-password');

  };

  const clickDelete = () => {

    navigate('/web-user/delete-user');
      ...
      <main>
        <div className="mx-auto max-w-7xl px-4 py-6 sm:px-6 lg:px-8">
          <div className='grid gap-4 grid-cols-1 md:grid-cols-2'>
            <div
              className='border rounded-md p-2 shadow shadow-gray-400 cursor-pointer group'
